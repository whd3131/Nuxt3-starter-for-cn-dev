<template>
  <footer class="bg-white dark:bg-[#222222]" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="grid grid-cols-2 gap-8 xl:col-span-2">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Solutions</h3>
              <ul role="list" class="mt-6 space-y-4">
                <li v-for="item in navigation.solutions" :key="item.name">
                  <a :href="item.href" class="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-white">{{ item.name }}</a>
                </li>
              </ul>
            </div>
        ...
        <div class="mt-10 xl:mt-0">
          ...
          <p class="mt-2 text-sm leading-6 text-gray-600 dark:text-white">The latest news, articles, and resources, sent to your inbox weekly.</p>
      ...
      <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
        ...
        <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0 dark:text-white">&copy; 2020 Your Company, Inc. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
